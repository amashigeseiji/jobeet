...
$browser->info('1 - The homepage')->
  get('/')->
  info(' 1.3 - A category has a link to the category page only if too many page')->
  with('response')->begin()->
...
$browser->info(' 3.6 - A job validity count be extended before the job expires soon')->
